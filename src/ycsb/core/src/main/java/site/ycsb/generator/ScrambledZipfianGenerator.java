...
*/
  ...
  public ScrambledZipfianGenerator(long min, long max, double zipfianconstant, double zetainput) {
    this.min = min;
    this.max = max;
    itemcount = this.max - this.min + 1;
    gen = new ZipfianGenerator(0, ITEM_COUNT, zipfianconstant, zetainput);
  }
