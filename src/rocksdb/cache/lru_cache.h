...
class ALIGN_AS(CACHE_LINE_SIZE) LRUCacheShard final : public CacheShard {
 public:
  ...
  virtual void PrepareSingleKeyRecord(
      const Slice& /**/, void*, Cache::KeyRecord /**/) override; 
  virtual Cache::KeyRecords ReleaseKeyRecords() override; 
  virtual void ClearKeyRecords() override; 
