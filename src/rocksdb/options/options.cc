...
ColumnFamilyOptions* ColumnFamilyOptions::OptimizeLevelStyleCompaction(
  ...
  write_buffer_size = static_cast<size_t>(memtable_memory_budget * 2);
  ...
  fprintf(stderr, "min_write_buffer_number_to_merge %d\n", 
      min_write_buffer_number_to_merge);
  fprintf(stderr, "max_write_buffer_number %d\n", 
      max_write_buffer_number);
  fprintf(stderr, "level0_file_num_compaction_trigger %d\n", 
      level0_file_num_compaction_trigger);
