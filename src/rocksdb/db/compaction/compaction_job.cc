...
void CompactionJob::ProcessKeyValueCompaction(SubcompactionState* sub_compact) {
  ...
  CompactionHints hint;
  hint.start_level = sub_compact->compaction->start_level();
  hint.output_level = sub_compact->compaction->output_level();
  hint.is_input = true;
  hint.is_involved = true;
  hint.job_id = job_id_;
  read_options.compaction_hints = hint;
...
Status CompactionJob::OpenCompactionOutputFile(
  ...
  fo_copy.level = sub_compact->compaction->output_level();
  ...
  hint.is_involved = true;
  hint.job_id = job_id_;
  writable_file.get()->CompactionHint(hint);
